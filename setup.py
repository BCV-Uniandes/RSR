...
if __name__ == '__main__':
    ...
    setup(
        name='RSR',
        version=get_version(),
        description='Generalized Real-World Super-Resolution',
        long_description=readme(),
        author='Angela Castillo',
        author_email='a.castillo13@uniandes.edu.co',
        keywords='computer vision, super resolution, real world super resolution, gans, robust training',
        url='https://github.com/BCV-Uniandes/RSR',
